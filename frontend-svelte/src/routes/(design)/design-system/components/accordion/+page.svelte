  ...
  const faqs = [
    {
      question: '복슬홈이 무엇인가요?',
      answer:
        '복슬홈은 개인 지식 관리를 위한 올인원 플랫폼입니다. 게시판, 지식 베이스, 노트, 메모 등의 기능을 통해 정보를 체계적으로 관리할 수 있습니다.'
    },
    {
      question: '어떤 기술 스택을 사용하나요?',
      answer:
        '백엔드는 Spring Boot + Kotlin을 사용하고, 프론트엔드는 SvelteKit + TypeScript를 사용합니다. 디자인 시스템으로는 shadcn-svelte와 Tailwind CSS를 활용합니다.'
    },
    {
      question: '데이터는 어떻게 저장되나요?',
      answer:
        '현재는 H2 Database를 사용하고 있으며, 향후 PostgreSQL로 마이그레이션할 예정입니다. 모든 데이터는 안전하게 암호화되어 저장됩니다.'
    },
    {
  ...
  const projectStructure = [
    {
      ...
      children: [
        {
          name: 'backend',
          children: [{ name: 'src/main/kotlin/com/setvect/bokslhome' }, { name: 'build.gradle.kts' }, { name: 'application.yml' }]
        },
        {
          name: 'frontend',
          children: [
            {
              name: 'src',
              children: [{ name: 'routes' }, { name: 'lib/components' }, { name: 'lib/stores' }, { name: 'lib/utils' }]
            },
            { name: 'package.json' },
            { name: 'vite.config.ts' }
          ]
        ...
        {
          name: 'docs',
          children: [{ name: 'TODO' }, { name: 'API.md' }, { name: 'README.md' }]
        }
      ]
    }
  ];
...
<section class="space-y-8">
  ...
  <div class="space-y-6">
        ...
        <Card.Content class="p-6">
          <Accordion.Root class="w-full">
            <Accordion.Item value="item-1">
              ...
              <Accordion.Content>
                <p class="text-muted-foreground">
                  이것은 첫 번째 아코디언 섹션의 내용입니다. 클릭하여 내용을 펼치거나 접을 수 있습니다. 긴 내용이 있을 때 공간을
                  절약하면서도 필요할 때만 정보를 표시할 수 있어 유용합니다.
                </p>
              </Accordion.Content>
            </Accordion.Item>
            <Accordion.Item value="item-2">
              ...
              <Accordion.Content>
                <p class="text-muted-foreground">
                  두 번째 아코디언 섹션입니다. 각 섹션은 독립적으로 동작하며, 여러 섹션을 동시에 열 수도 있고 하나만 열리도록 설정할 수도
                  있습니다.
                </p>
              </Accordion.Content>
            </Accordion.Item>
            <Accordion.Item value="item-3">
              ...
              <Accordion.Content>
                <div class="space-y-4">
                  <p class="text-muted-foreground">세 번째 섹션에는 다양한 콘텐츠를 포함할 수 있습니다.</p>
    ...
    <div class="space-y-4">
      ...
      <Card.Root>
        <Card.Content class="p-6">
          <p class="text-sm text-muted-foreground mb-4">type="single" 속성을 사용하면 한 번에 하나의 섹션만 열리도록 할 수 있습니다.</p>
          <Accordion.Root type="single" class="w-full" collapsible>
            ...
            <Accordion.Item value="single-3">
              ...
              <Accordion.Content>
                <div class="space-y-3">
                  <p class="text-muted-foreground">개인정보 처리방침에 따라 데이터를 안전하게 관리합니다.</p>
                  <div class="flex gap-2">
