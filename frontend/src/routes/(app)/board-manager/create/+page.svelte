  ...
  <Card>
    ...
    <CardContent class="space-y-6">
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center space-x-4">
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.replyF} value={true} disabled={submitting} class="text-primary" />
            <span class="text-sm">예</span>
          </label>
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.replyF} value={false} disabled={submitting} class="text-primary" />
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center space-x-4">
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.attachF} value={true} disabled={submitting} class="text-primary" />
            <span class="text-sm">예</span>
          </label>
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.attachF} value={false} disabled={submitting} class="text-primary" />
            <span class="text-sm">아니오</span>
          </label>
        </div>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center space-x-4">
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.commentF} value={true} disabled={submitting} class="text-primary" />
            <span class="text-sm">예</span>
          </label>
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.commentF} value={false} disabled={submitting} class="text-primary" />
            <span class="text-sm">아니오</span>
          </label>
        </div>
      </div>
      ...
      <div class="space-y-3">
        ...
        <div class="flex items-center space-x-4">
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.encryptF} value={true} disabled={submitting} class="text-primary" />
            <span class="text-sm">예</span>
          </label>
          <label class="flex items-center space-x-2">
            <input type="radio" bind:group={formData.encryptF} value={false} disabled={submitting} class="text-primary" />
            <span class="text-sm">아니오</span>
          </label>
        </div>
      </div>
