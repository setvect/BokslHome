 ...
 * Network 수정
 */
export async function updateNetwork(networkSeq: number, request: NetworkRequest): Promise<NetworkResponse> {
 ...
 * Network 목록 페이징 조회
 */
export async function getNetworkPage(params: { title?: string; page?: number; size?: number }): Promise<NetworkPageResponse> {
