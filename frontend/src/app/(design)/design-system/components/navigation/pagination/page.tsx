    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          대용량 콘텐츠를 여러 페이지로 나누어 탐색할 수 있게 하는 페이지네이션 컴포넌트입니다.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            UI 패키지에서 제공하는 기본 컴포넌트를 조합하면 자유롭게 페이지네이션을 구성할 수 있습니다.
          </CardDescription>
        </CardHeader>
          ...
          <div className="bg-muted p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => copyToClipboard(BASIC_PAGINATION_CODE, "pagination-basic")}
              >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            동작 로직을 캡슐화한 고수준 컴포넌트로, 필요한 속성만 지정하면 됩니다.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-3">
          ...
          <div className="bg-muted p-4 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <Button
                variant="ghost"
                size="sm"
                onClick={() => copyToClipboard(PAGINATION_NAV_CODE, "pagination-nav")}
              >
